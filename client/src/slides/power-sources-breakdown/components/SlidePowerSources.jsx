...
class SlidePowerSources extends React.Component {
  ...
  render() {
    const highestSourceOfPower = this.findHighestSourceOfPower(
      this.props.data.latestPowerBreakdown
    );
    ...
    Object.keys(currentData).forEach((installationType) => {
      const newComponent = (
        <div
          ...
          className="column is-6-widescreen is-6-full-hd is-6-desktop is-4-tablet is-6-mobile "
          style={{ marginTop: "10px" }}
        >
          <PowerSourceProduction
            key={installationType}
            production={currentData[installationType].power}
            type={installationType}
            cssClass="power-sources"
          />
        </div>
      );
      ...
      <React.Fragment>
        ...
        >
          ...
          <div className="columns" style={{ marginBottom: "2rem" }}>
            <div className="column is-full has-text-centered">
              <div className="is-size-6">
                ...
                , on produit de l’énergie de différentes manières, c’est ce
                qu’on appelle un « mix » énergétique.
              </div>
              <div className="is-size-5" style={{ marginTop: "2rem" }}>
                ...
                , l’énergie {highestSourceOfPower} est la source de production
                électrique la plus importante.
              </div>
            </div>
          </div>
          <div className="columns is-multiline is-centered">
            ...
            >
              <GraphPowerSourceBreakdown
                productionsOverTime={this.props.data.powerBreakdownHistory}
